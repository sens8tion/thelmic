...
def _pression_step_values(step_in_bar: int, bar_pression: dict,
    ...
    """Delegate to pression_engine — server.py is behaviour-transparent."""
    return _pression_engine.compute_step(step_in_bar, bar_pression, kick_steps, snare_steps)
...
def _compute_pression_bar(bar: int, n_bars: int, phrases_until_drop: int,
    ...
    """Delegate to pression_engine — server.py is behaviour-transparent."""
    return _pression_engine.compute_bar(bar, n_bars, phrases_until_drop, dims, heat, is_post_drop)
